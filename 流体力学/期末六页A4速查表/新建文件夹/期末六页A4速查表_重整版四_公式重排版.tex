...
\end{tikzpicture}\end{center}\vspace{-3pt}}
\newcommand{\pvzfig}{\par\vspace{-4pt}\noindent\hfill\begin{tikzpicture}[>=Latex,scale=.35,every node/.style={font=\tiny},baseline=(current bounding box.center)]
...
\end{gathered}}
\renewcommand{\arraystretch}{0.58}\begin{tabular}{|p{0.16\linewidth}|p{0.36\linewidth}|p{0.36\linewidth}|}
...
\infoh{势流信息库C 常见结论库}
\infotxt{%
\renewcommand{\arraystretch}{0.58}\begin{tabular}{|p{0.31\linewidth}|p{0.60\linewidth}|}
...
\infotxt{%
\renewcommand{\arraystretch}{0.58}\begin{tabular}{|p{0.28\linewidth}|p{0.63\linewidth}|}
...
\begin{tabular}{|p{0.28\linewidth}|p{0.66\linewidth}|}\hline
