...
\begin{document}
\fontsize{3.16}{3.34}\selectfont
\begin{center}
{\heiti\fontsize{6.5}{6.8}\selectfont 流体力学期末开卷资料：母题证据链版七}\par
{\fontsize{3.20}{3.38}\selectfont 题干定位 $\to$ 母题 $\to$ 真题/子题 $\to$ 公式链 $\to$ 易错；旧版 v106/重整版五内容按母题归位，不按来源分散查找。}
\end{center}
\vspace{-3.4pt}
\begin{multicols}{3}
...
\qt{公式链：粘性管流，N-S、H-P、Couette、管内压损}
\begin{vfourWrap}
