...
\begin{center}
    {\Large\bfseries 圆管在弯扭组合作用下的应力与内力测试实验报告(由 Gemini 生成)}\\[4pt]
    {\normalsize 固体力学基础实验}\\[8pt]
    \begin{tabular}{>{\bfseries}r l >{\bfseries}r l >{\bfseries}r l >{\bfseries}r l}
        姓名： & 纪文龙 & 学号： & 2024012842 & 班级： & 行健烽火4 & 日期： & 2026年5月26日
    \end{tabular}
\end{center}
...
\begin{table}[H]
    ...
    \begin{tabular}{lccc}
        ...
        \midrule
        IMG\_1869 & $-201.1$ & $-291.246$ & $0.0008$ \\
        IMG\_1870 & $-203.5$ & $-291.246$ & $0.0008$ \\
        IMG\_1871 & $-197.2$ & $-295.056$ & $0.0010$ \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrrrrr}
        ...
        IMG\_1872 & 25.9 & -270.9 & -215.9 & 72.2 & -24.9 & 276.6 & 212.4 \\
...
\begin{align}
    ...
    =206000\times 273.4\times10^{-6}
    =56.3\,\mathrm{MPa},\\
    \tau_{x\theta} &= G\gamma_{x\theta}
    =79230.8\times 427.6\times10^{-6}
    =33.9\,\mathrm{MPa}.
\end{align}
...
\begin{align}
    \sigma_1
    &=\frac{56.3}{2}+\sqrt{\left(\frac{56.3}{2}\right)^2+33.9^2}
    =72.2\,\mathrm{MPa},\\
    \sigma_2
    &=\frac{56.3}{2}-\sqrt{\left(\frac{56.3}{2}\right)^2+33.9^2}
    =-15.9\,\mathrm{MPa}.
...
主方向相对圆管轴向的夹角为
\begin{equation}
    \theta=\frac12\arctan\left(\frac{2\times33.9}{56.3}\right)
    =25.1^\circ .
\end{equation}
...
第三，主应力计算表明该危险点处为拉压主应力并存状态，最大主应力约 $72.2\,\mathrm{MPa}$，最小主应力约 $-15.9\,\mathrm{MPa}$，主方向与圆管轴线夹角约 $25.1^\circ$。这与弯曲正应力和扭转剪应力共同作用下的平面应力状态一致。
...
\[
    \varepsilon_b=273.4\,\ue,\qquad
    \gamma_{x\theta}=427.6\,\ue .
\]
按 $E=206\,\mathrm{GPa}$、$\nu=0.30$ 计算，危险点处
\[
    \sigma_x=56.3\,\mathrm{MPa},\qquad
    \tau_{x\theta}=33.9\,\mathrm{MPa},
\]
主应力为
\[
    \sigma_1=72.2\,\mathrm{MPa},\qquad
    \sigma_2=-15.9\,\mathrm{MPa},\qquad
    \theta=25.1^\circ .
\]
