...
\idq{题图识别+查表+公式链}
\idq{题图一眼选模型}
\renewcommand{\arraystretch}{0.80}\begin{tabular}{|p{0.30\linewidth}|p{0.62\linewidth}|}
...
\infoh{势流信息库C 常见结论库}
\renewcommand{\arraystretch}{0.72}\begin{tabular}{|p{0.31\linewidth}|p{0.60\linewidth}|}
...
\renewcommand{\arraystretch}{0.72}\begin{tabular}{|p{0.28\linewidth}|p{0.63\linewidth}|}
...
\renewcommand{\arraystretch}{0.90}\begin{tabular}{|p{0.30\linewidth}|p{0.61\linewidth}|}
