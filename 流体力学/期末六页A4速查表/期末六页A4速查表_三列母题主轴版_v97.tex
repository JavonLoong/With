...
\modu{母题4扩展A：基本流表}{均匀流、点源、点汇、点涡、偶极}{按题直接相加}{均匀流：\(\varphi=Ur\cos\theta,\psi=Ur\sin\theta\)；源：\(\varphi={Q\over2\pi}\ln r,\psi={Q\over2\pi}\theta\)；涡：\(v_\theta=\Gamma/(2\pi r)\)}{填空：点涡除原点外无旋；半平面常把\(2\pi\)变\(\pi\)}
