...
\newcommand{\chap}[1]{\vspace{0.35pt}\colorbox{subbg}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep\relax}\fontsize{6.55}{6.78}\selectfont\bfseries\color{h1}#1\end{minipage}}\par\vspace{0.15pt}}
...
\end{tikzpicture}\end{center}\vspace{-3pt}}
\newcommand{\pvzfig}{\par\vspace{-4pt}\noindent\hfill\begin{tikzpicture}[>=Latex,scale=.22,every node/.style={font=\tiny},baseline=(current bounding box.center)]
