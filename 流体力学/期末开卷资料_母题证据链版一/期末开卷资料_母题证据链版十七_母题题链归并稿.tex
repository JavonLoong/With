...
\begin{center}
{\heiti\fontsize{6.1}{6.35}\selectfont 流体力学期末开卷资料：母题证据链版十七}\par
...
\ans{\textbf{旧版关键词归位：}v106/v108/重整版五里的“管路/静水/CV 基础读题”归母题1--3；“基本流、镜像、圆柱、环量、半圆柱升力”归母题4；“等熵 Ma 链、临界/最大流量、测压计反推背压、面积比求两支、三个背压、设计工况汞柱、渐缩喷管、内激波、外喷管欠/过膨胀”归母题5；“管内层流/湍流、壁面律、雷诺应力、边界层厚度”归母题6--7；“给速度场 $u,v,w$、由 $\nabla\!\cdot P=-\rho f$ 求体力、应力张量”归母题8；“文丘里/孔口/水击/水波/明渠”归母题16。看到旧版标题时不要翻目录，直接进对应母题的真题链。}
\qt{子题：每道计算题的标准落笔骨架。}
...
\mt{母题11 静水/CV/势流/相似短题：小问也按完整题链写}
...
\mt{母题14 管路与水力机械变式：泵吸水/水轮机/虹吸/并联}
...
\mt{母题17 测压计/U管/自由涡/外绕阻力：零碎题统一成题链}
