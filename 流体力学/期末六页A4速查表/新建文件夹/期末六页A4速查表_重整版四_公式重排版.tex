...
\newcommand{\chap}[1]{\vspace{0.35pt}\colorbox{h1}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep\relax}\fontsize{7.50}{7.80}\selectfont\bfseries\color{white}#1\end{minipage}}\par\vspace{0.15pt}}
