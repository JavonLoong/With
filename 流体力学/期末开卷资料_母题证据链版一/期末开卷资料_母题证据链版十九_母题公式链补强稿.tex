...
\newcommand{\boxmini}[1]{\colorbox{warnbg}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep\relax}\fontsize{2.66}{2.80}\selectfont #1\end{minipage}}\par}
...
\newenvironment{vfourWrap}{\par\begingroup\fontsize{2.66}{2.80}\selectfont\setlength{\fboxsep}{0.38pt}}{\par\endgroup}
\begin{document}
\fontsize{2.96}{3.08}\selectfont
\begin{center}
{\heiti\fontsize{6.1}{6.35}\selectfont 流体力学期末开卷资料：母题证据链版十九}\par
...
\mt{母题21 管路/泵阀/粗糙度题型总包：把 PVZ 从题干写到答案}
