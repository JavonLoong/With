...
\setlength{\parskip}{0.06pt}
\setlength{\columnsep}{1.05mm}
\setlength{\columnseprule}{0.08pt}
\setlength{\tabcolsep}{0.32pt}
\setlength{\fboxsep}{0.30pt}
...
\newcommand{\mt}[1]{\vspace{0.22pt}\colorbox{M}{\parbox{\dimexpr\linewidth-2\fboxsep}{\color{white}\bfseries #1}}\par}
\newcommand{\qt}[1]{\vspace{0.10pt}\colorbox{Q}{\parbox{\dimexpr\linewidth-2\fboxsep}{\color{white}\bfseries #1}}\par}
...
\begin{center}
{\heiti\fontsize{6.1}{6.35}\selectfont 流体力学期末开卷资料：母题证据链版十八}\par
...
\form{静水链：先定自由液面和深度$h$。平面壁$F=\rho gh_cA,\ y_p=y_c+I_c/(y_cA)$；曲面拆$F_H=\rho gh_cA_v,\ F_V=$压力体水重；浮体$F_B=\rho gV_{\rm 排}$；测压管/U管沿同一静止液体等压面逐段写$p+\rho gz=C$。}
