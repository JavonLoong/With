...
\text{极：}\tfrac{\partial v_r}{\partial r} + \tfrac{v_r}{r} + \tfrac{\partial v_\theta}{r\partial\theta}=0\\
\text{极无旋：}\Omega_z=\tfrac{\partial v_\theta}{\partial r} + \tfrac{v_\theta}{r} - \tfrac{\partial v_r}{r\partial\theta}=0\\
...
\vspace*{-5pt}
\centering
\begin{tikzpicture}[>=Latex,scale=0.50,every node/.style={font=\tiny}]
...
\draw[<->] (2.45,-1.18)--(2.45,-0.86); \node[right] at (2.60,-1.02){$h=15$cm Hg};
...
\par\noindent \begin{tabular}{|p{0.22\linewidth}|p{0.69\linewidth}|}\hline
