...
\fmlb{\begin{gathered}
\nabla\cdot\bm V = \nabla^2\phi = u_x+v_y+w_z = 0\\
\nabla\times\bm V = 0 \Rightarrow \Omega_z = v_x-u_y = -\nabla^2\psi = 0\\
\text{枻：}\nabla\cdot\bm V = \tfrac{\partial(rv_r)}{r\partial r}+\tfrac{\partial v_\theta}{r\partial\theta}=0\\
\text{枻无旋：}\Omega_z = \tfrac{\partial(rv_\theta)}{r\partial r}-\tfrac{\partial v_r}{r\partial\theta} = 0\\
u=\phi_x=\psi_y,\ v=\phi_y=-\psi_x\\
v_r=\phi_r=\tfrac{\psi_\theta}{r},\ v_\theta=\tfrac{\phi_\theta}{r}=-\psi_r\\
