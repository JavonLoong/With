...
for commit in commits:
    ...
    if 'schemeviscous' in content:
        idx = content.find('newcommand{\\schemeviscous}')
        if idx != -1:
            ...
            if tik_start != -1 and tik_end != -1:
                ...
                if norm not in seen_schemeviscous:
                    seen_schemeviscous.add(norm)
