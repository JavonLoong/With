...
\idq{题图识别+查表+公式链}
\idq{题图一眼选模型}
\renewcommand{\arraystretch}{0.80}\begin{tabular}{|p{0.22\linewidth}|p{0.70\linewidth}|}
...
\fmlb{\begin{gathered}
\nabla\cdot\bm V=0,\ \nabla\times\bm V=0,\ \bm V=\nabla\phi,\ \nabla^2\phi=0\\
\text{直角：}u_x+v_y+w_z=0,\ \Omega_z=v_x-u_y=0\\
\text{枻：}\frac{\partial(rv_r)}{r\partial r}+\frac{\partial v_\theta}{r\partial\theta}=0,\ \Omega_z=\frac{\partial(rv_\theta)}{r\partial r}-\frac{\partial v_r}{r\partial\theta}=0\\
\nabla^2\psi=-\Omega_z,\ u=\phi_x=\psi_y,\ v=\phi_y=-\psi_x\\
v_r=\phi_r=\psi_\theta/r,\ v_\theta=\phi_\theta/r=-\psi_r\\
p=p_\infty+\tfrac12\rho(U_\infty^2-V^2),\ C_p=1-(V/U_\infty)^2,\ q'=\psi_2-\psi_1
\end{gathered}}
\renewcommand{\arraystretch}{0.72}\begin{tabular}{|p{0.16\linewidth}|p{0.36\linewidth}|p{0.36\linewidth}|}
...
\infoh{势流信息库C 常见结论库}
\renewcommand{\arraystretch}{0.72}\begin{tabular}{|p{0.22\linewidth}|p{0.69\linewidth}|}
...
\begin{tabular}{|p{0.22\linewidth}|p{0.69\linewidth}|}\hline
...
\renewcommand{\arraystretch}{0.90}\begin{tabular}{|p{0.22\linewidth}|p{0.69\linewidth}|}
...
\lookq{小查表：空气等熵/PM}
\renewcommand{\arraystretch}{0.80}\begin{tabular}{|c|c|c|c|c|}
