...
\newcommand{\sect}[1]{\vspace{0.12pt}{\fontsize{5.30}{5.48}\selectfont\bfseries\color{h1}\colorbox{h2}{\color{white}\fontsize{4.55}{4.65}\selectfont 子题}\,#1}\par}
\newcommand{\exm}[1]{{\fontsize{5.00}{5.18}\selectfont\bfseries\color{tip}\colorbox{tip}{\color{white}\fontsize{4.35}{4.45}\selectfont 变式}\,#1}\par}
