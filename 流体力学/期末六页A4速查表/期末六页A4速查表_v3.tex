...
\begin{multicols}{3}
\chap{P1 总判题地图：先选模型}
\miniimg{0.48}{assets/img08_models.jpg}
\sect{考试资料策略}
...
\miniimg{0.48}{assets/img01_potential.jpg}
\sect{基本条件}
...
\miniimg{0.48}{assets/img04_laval.jpg}
\sect{基本公式}
...
\begin{multicols}{3}
\chap{P4 激波 + 膨胀波}
\miniimg{0.42}{assets/img02_shock.jpg}
\miniimg{0.42}{assets/img03_pm.jpg}
\sect{总判断}
...
\miniimg{0.48}{assets/img05_viscous.jpg}
\sect{N-S 简化}
...
\begin{multicols}{3}
\chap{P6 边界层、阻力、最后急救}
\miniimg{0.48}{assets/img06_bl.jpg}
\sect{平板边界层}
$Re_x=Ux/\nu,\;Re_L=UL/\nu$。层流：\\
