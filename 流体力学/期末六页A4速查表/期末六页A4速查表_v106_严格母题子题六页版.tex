...
\newcommand{\sect}[1]{\vspace{0.16pt}{\fontsize{5.35}{5.55}\selectfont\bfseries\color{h2}$\blacktriangleright$ 子题：#1}\par}
\newcommand{\exm}[1]{{\fontsize{5.05}{5.25}\selectfont\bfseries\color{tip}$\diamond$ 子题：#1}\par}
