...
\usepackage[top=2.55mm,bottom=2.55mm,left=2.75mm,right=2.75mm]{geometry}
...
\setlength{\fboxsep}{0.72pt}
\setlength{\emergencystretch}{0.9em}
\sloppy
\raggedcolumns
...
\definecolor{G}{HTML}{FBFDFF}
\definecolor{Y}{HTML}{FFFEF5}
...
\newcommand{\labtag}[3]{{\bfseries\color{#1}\colorbox{#1}{\color{white}\fontsize{2.8}{2.95}\selectfont #2}\,#3}\par}
...
\newcommand{\boxmini}[1]{\colorbox{warnbg}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep\relax}\fontsize{3.2}{3.38}\selectfont #1\end{minipage}}\par}
...
\newcommand{\platefig}{}
\begin{document}
\fontsize{4.02}{4.24}\selectfont
\begin{center}
{\heiti\fontsize{7.6}{7.9}\selectfont 流体力学期末开卷资料：母题证据链版二}\par
{\fontsize{3.95}{4.12}\selectfont 题干定位 $\to$ 母题 $\to$ 真题/子题 $\to$ 公式链 $\to$ 易错；v106 与重整版五已按母题回流。}
\end{center}
\vspace{-2.2pt}
\begin{multicols}{3}
...
\qt{重整版五回流：母题1 子题/变式/公式链}
{\fontsize{3.48}{3.68}\selectfont
\pvzfig
...
\qt{v106回流：旧母题1 细题链/易错/查表}
{\fontsize{3.42}{3.60}\selectfont
\pvzfig
