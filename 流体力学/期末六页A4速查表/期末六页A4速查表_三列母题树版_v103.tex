...
\newcommand{\pipefig}{\tinyfig{\begin{tikzpicture}[>=Latex,scale=.36,every node/.style={font=\tiny}]
...
\end{tikzpicture}}}
\newcommand{\hydrofig}{\tinyfig{\begin{tikzpicture}[>=Latex,scale=.35,every node/.style={font=\tiny}]
\draw[thick](0,0)--(2,0)--(2,1.25)--(0,1.25)--cycle;\draw[blue](0,1)--(2,1);\draw[thick](2.55,0)--(3.55,1.25);
\draw[->,blue](3.05,.55)--(3.48,.85);\node at(1,1.12){free};\node at(3.35,.35){gate};
\end{tikzpicture}}}
\newcommand{\cvfig}{\tinyfig{\begin{tikzpicture}[>=Latex,scale=.36,every node/.style={font=\tiny}]
...
\end{tikzpicture}}}
\newcommand{\lavalfig}{\tinyfig{\begin{tikzpicture}[>=Latex,scale=.35,every node/.style={font=\tiny}]
...
\end{tikzpicture}}}
\newcommand{\blfig}{\tinyfig{\begin{tikzpicture}[>=Latex,scale=.35,every node/.style={font=\tiny}]
