# -*- coding: utf-8 -*-
"""
FAST full chat history export: scroll to very top, then capture every page downward.
...
SCREENSHOT_DIR = r"d:\虚拟C盘\光\chat_screenshots"
OUTPUT_HTML = r"d:\虚拟C盘\光\小琳_聊天记录.html"
...
def get_screen_hash(region):
    """Take screenshot and return hash + image"""
...
def detect_input_box_top(left, right, bottom, top_limit):
    ...
    # 从底部向上扫描，输入框通常是浅色背景（RGB > 230），聊天区背景较深
    h = arr.shape[0]
...
def main():
    ...
    log("=" * 60)
    log("  WeChat Chat Screenshot Export - 小琳 (FAST)")
    log("=" * 60)
    ...
    # Bring to foreground and move into visible area
    ...
    # Use Ctrl+Home, then scroll up with a MAX LIMIT
    # ============================================
    log("\n[Step 1] Jumping to top (Ctrl+Home + scroll)...")
    ...
    # Then do limited scroll up to handle any remaining
    ...
    # ============================================
    # PHASE 2: Capture screenshots going DOWN (FAST!)
    # ============================================
