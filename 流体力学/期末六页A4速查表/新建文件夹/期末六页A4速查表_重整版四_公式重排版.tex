...
\end{tikzpicture}\end{center}\vspace{-3pt}}
\newcommand{\pvzfig}{\par\vspace{-2pt}\noindent\hfill\begin{tikzpicture}[>=Latex,scale=0.68,every node/.style={font=\tiny},baseline=(current bounding box.center)]
